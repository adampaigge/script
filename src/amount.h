...
#ifndef SCRIPT_AMOUNT_H
#define SCRIPT_AMOUNT_H
 ...
 *
 * Note that this constant is *not* the total money supply, which in Script
 * currently happens to be less than 840,000,000,000 SCRIPT for various reasons, but
